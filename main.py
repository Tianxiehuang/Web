...
for url in urls:
    ...
    if 1:
        try:
            ...
            pic.save('D:/core/web/son-project/data/data/Chinese_web/pic' + str(-m) + '.xls')
...
###
    ...
    #img_elements = driver.find_element(By.tagName("img"))
    ...
    for img in img_elements:
        ...
        print(n)
        #print(src)
        #test_path = os.path.abspath(r"C:\Users\lenovo\Desktop\Data-Task\pic\\"+str(n)+'.jpg')
